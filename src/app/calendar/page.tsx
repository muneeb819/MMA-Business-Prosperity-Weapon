        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/40 mt-1">Schedule & event management</p>
            </div>
            <button className="flex items-center gap-2 px-4 py-2 bg-blue-500/20 text-blue-400 rounded-lg border border-blue-500/30 hover:bg-blue-500/30 transition-all text-sm">
              ...
              <GlassCard glow="blue">
                <GlassCardContent>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <h2 className="text-base font-semibold text-white">{currentMonth}</h2>
                    <button className="p-1.5 rounded-lg hover:bg-white/5 transition-all">
              ...
              <GlassCard glow="purple">
                ...
                <GlassCardContent className="space-y-3">
                  ...
                  {events.filter((e) => e.day === selectedDay).length === 0 && (
                    <p className="text-white/30 text-sm text-center py-4">No events for this day</p>
                  )}
                </GlassCardContent>
              </GlassCard>
