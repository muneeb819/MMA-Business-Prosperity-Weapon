      ...
      <PageTransition>
        <div className="p-6 space-y-6">
          <div>
            ...
            <p className="text-sm text-white/40 mt-1">Team members & performance</p>
          </div>
              ...
              <StaggerItem key={i}>
                <GlassCard glow="blue" className="p-5">
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${member.color} flex items-center justify-center text-white font-bold text-sm`}>
                      {member.avatar}
                    </div>
                  ...
                  <div className="flex items-center gap-3 mt-4 pt-3 border-t border-white/5">
                    <button className="flex items-center gap-1.5 text-xs text-white/30 hover:text-blue-400 transition-all">
              ...
              <div className="space-y-3">
                {performanceData.map((member, i) => (
                  <div key={i} className="flex items-center gap-4">
                    <span className="text-xs text-white/60 w-24 truncate">{member.name}</span>
                    ...
                    <span className="text-xs text-white/40 w-8 text-right">{member.value}%</span>
                  </div>
                ))}
              </div>
            </GlassCardContent>
