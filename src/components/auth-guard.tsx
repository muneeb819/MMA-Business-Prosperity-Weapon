    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <Button onClick={() => router.push("/login")} className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white shadow-lg shadow-cyan-500/20">
            Go to Login
          </Button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <p className="text-zinc-400">You don&apos;t have permission to view this page. Required role: <span className="text-cyan-400 font-medium">{requiredRole}</span></p>
